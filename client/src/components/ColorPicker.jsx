        ...
        <div>
            <div className="flex flex-col items-stretch md:flex-row">
                <div className="md:w-3/4 md:pr-5 md:mb-0 mb-5">
                    <Slider name="Red" min="0" max="255" onChange={onChangeRed} value={red} />
                    <Slider name="Green" min="0" max="255" onChange={onChangeGreen} value={green}/>
                    <Slider name="Blue" min="0" max="255" onChange={onChangeBlue} value={blue}/>
                </div>
                <div 
